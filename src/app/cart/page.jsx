...
function Page() {
    ...
    return (
        <>
            <Heading 
                title='Your Gaming Cart - Secure Checkout at AD Gaming'
                description={`Ready to complete your purchase? Review your selections in AD Gaming's secure gaming cart and get closer to your next epic gaming experience.`}
                keywords={`Gaming Cart, AD Gaming Checkout, Secure Purchase, Online Gaming Shop, Game Cart`}
            />
            {
                loading ? (
                    <Loader />

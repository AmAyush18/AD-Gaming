    ...
    <div className='w-[100vw] flex flex-col justify-center items-center'>
        ...
        <div className="w-[100vw] flex flex-col items-center m-auto pt-6">
                ...
                {giveawayGames.map((game) => (
                    <div key={game.id} className='relative'>
                        ...
                        <div className='absolute bottom-0 left-0 p-4'>
                            <p className={`${staatliches.className} text-xl uppercase font-bold`}>{game.title}</p>
                        </div>
                    </div>
                ))}
            </div>
            ...
            <div className="mt-5 w-[100%] mb-9 flex flex-col items-center flex-wrap">
                <span className={`${staatliches.className} w-[90%] uppercase text-center mb-1 text-3xl text-[#7C8BD0]`}> Want to stay updated with Ad network? </span>
                <span className={`${staatliches.className} w-[90%] uppercase text-center mb-3 text-3xl text-[#7C8BD0]`}> Sign up now! </span>
            </div>

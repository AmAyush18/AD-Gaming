    ...
    <>
        <div className='w-[100%] support'>
            ...
            <div className="items-center bg-black bg-opacity-45 text-white flex flex-col justify-center m-auto">
                ...
                />
                <div className='w-[65%] m-auto p-4 !mb-5'>
                ...
                <div className='w-[90%] flex flex-col 800px:flex-row justify-around m-auto'>
                ...
                <div className='w-[90%] flex flex-col 800px:flex-row-reverse justify-around m-auto'>
                    <div className="w-[100%] 800px:w-[45%] text-right mt-6 mb-6">
                        <Image 
                            src={programming}
                            alt=''
                ...
                <div className="!bg-[#00171F] h-[150px] w-[100vw] p-24 m-auto">
                    ...
                    <p className='w-[100%] 800px:w-[70%] mt-6 m-auto text-center'>For any further enquires please contact us via email at adnetwork@gmail.com</p>
                </div>

export const news = [
    {
        ...
        brief: `Insomiac's Spider-man 2 is has finally in-stock at AD Network with lower prices, be the first to check out. `,
        description: [``, ``, ``, ``],
        genre: `game`,
    ...
    },
    {
        ...
        brief: `AD Network has had the chance of interviewing the developers of the new assassin's creed game straight from the Ubisoft`,
